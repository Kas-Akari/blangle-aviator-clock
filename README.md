# Manual Aviator Clock

This is a variant from flaparoo Aviator Clock app.

A clock for aviators, with local time and UTC - and the latest METAR
(Meteorological Aerodrome Report) for the airport saved on settings
...
- Latest METAR for the airport saved on settings (scrollable)
